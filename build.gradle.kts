...
dependencies {
    ...
    compileOnly("io.github.breninsul:rest-template-logging-interceptor:1.2.6")
    compileOnly("io.github.breninsul:okhttp-logging-interceptor:1.1.6")
    compileOnly("io.github.breninsul:servlet-logging-starter:1.0.2.3")
